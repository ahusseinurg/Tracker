...
public class PinActivity extends FragmentActivity {
    ...
    @Override public void onCreate(Bundle state) {
        ...
        root.setPadding(dp(28),dp(28),dp(28),dp(28)); root.setBackgroundColor(ModernUi.NAVY);
        ...
        pin.setPadding(dp(18),0,dp(18),0); ModernUi.outlined(pin,0x1affffff,0x66ffffff,14);
        ...
        unlock.setTextColor(Color.WHITE); ModernUi.fill(unlock,ModernUi.BLUE,14); ModernUi.elevate(unlock,2);
        ...
        if(!setup&&getSharedPreferences("media_library",MODE_PRIVATE).getBoolean("biometric_unlock",true)){
            ...
            if(BiometricManager.from(this).canAuthenticate(authenticators)==BiometricManager.BIOMETRIC_SUCCESS){
                Button biometric=new Button(this);biometric.setText("Use fingerprint or face");biometric.setTextSize(17);biometric.setAllCaps(false);biometric.setTextColor(ModernUi.NAVY);ModernUi.fill(biometric,Color.WHITE,14);biometric.setOnClickListener(v->showBiometric(authenticators));
